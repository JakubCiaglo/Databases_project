...
# 2. Stwórz wykres rozrzutu z linią regresji, aby zwizualizować zależność
plt.figure(figsize=(10, 6))
# sns.regplot jest idealny, bo od razu rysuje linię trendu
...
# Ustawiamy liczbę "schodków" na osi X, aby były to liczby całkowite
...
```
```{python}
df_feedback_incidents = pd.read_sql(query_feedback_incidents, engine)

print(df_feedback_incidents.to_string())
```