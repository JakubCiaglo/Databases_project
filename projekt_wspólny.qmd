...
if not trip_ids:
    df_disliked_trips = pd.DataFrame(columns=["Planeta", "Rodzaj", "Spacecraft", "Rocket", "Id"])
else:
...
df_disliked_trips.columns = ["Planeta", "Rodzaj", "Spacecraft", "Rocket", "Id"]
...
if not last_trips_ids:
    df_last_trips = pd.DataFrame(columns=["Planeta", "Rodzaj", "Spacecraft", "Rocket", "Id"])
else:
...
# --- Formatowanie końcowe ---
df_last_trips.columns = ["Planeta", "Rodzaj", "Spacecraft", "Rocket", "Id"]
...
if not top_5_ret_ids:
    df_liked_trips = pd.DataFrame(columns=["Planeta", "Rodzaj", "Spacecraft", "Rocket", "Id"])
else:
...
df_liked_trips.columns = ["Planeta", "Rodzaj", "Spacecraft", "Rocket", "Id"]
...
# --- Krok 2: Okno płatności i podział na kategorie ---
