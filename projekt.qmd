...
for i in range(n_employees):
    ...
    email = base_email + "@mkrm-spacetrips.com"
    suffix = 1
    while email in used_emails_emp:
        email = f"{base_email}{suffix}@mkrm-spacetrips.com"
        suffix += 1
...
def generate_spacecraft_entries():
    ...
    manufacturers = [
        "MKRM", "Boeing / MKRM", "MKRM / SpaceX", "NASA / Lockheed",
...
launch_stations = [
    ...
    ("MKRM Pad Baltic",        "Poland", "Ustka", "PLANNED")
]

rockets = [
    ("Falcon Heavy-U",     "MKRM / SpaceX",         "ACTIVE"),
    ("New Glenn-U",        "Blue Origin / MKRM",    "MAINT"),
    ("Starship-U",         "MKRM",                  "ACTIVE"),
    ("Vulcan Explorer",    "ULA / MKRM",            "ACTIVE"),
    ("Ariane 7",           "ESA / Arianespace",        "RETIRED"),
    ("Phoenix Booster",    "JAXA",                     "ACTIVE"),
    ("Sirius 9",           "Roscosmos",                "RETIRED"),
    ("CosmoLift X",        "MKRM",                  "MAINT"),
    ("Thunderbird-1",      "ISRO",                     "ACTIVE"),
    ("Atlas Prime",        "NASA / MKRM",           "PROTOTYPE")
]
